...
descripcion(alergia,'Es un conjunto de alteraciones de carácter respiratorio, nervioso o eruptivo que se produce en el sistema inmunologico por una extrezada sensibilidad del organismo a ciertas sustancias a las que a sido expuesto, y que en condiciones normales no causan estas alteraciones.').
...
descripcion(anemia_severa,'Es una enfermedad causada debido a la falta de hemoglobina en la sangre que esta por debajo del nivel normal o a niveles menos normales de glóbulos rojosen la sangre.').

descripcion(anorexia,'Es un trastorno de origen neurotico que se caracteriza por un rechazo sistemático de los alimentos y que se observa generalmente en personas jóvenes; suele ir acompañado de vómitos provocados, adelgazamiento extremo y, es el caso de las mujeres, desaparición de la mestruación').

descripcion(apendicitis,'Es una enfermedad inflamatoria infecciosa del apendice cecal, que, como su nombre lo indica, es un apendice que tiene la parte inicial del intestino grueso denominada ciego. Al ser una inflamación aguda, el dolor es de rápido inicio.').

descripcion(bronquiolitis,'Es la inflamacion de las vias repiratorias pequeñas, fundamentalmente en niños menores de 2 años. La bronquiolitis se caracteriza por secrecion nasal, tos y dificultad para respirar n lactantes con o sin fiebre, precedido por una ineccion respiratoria alta, tal como una coriza o una otitis media.').

descripcion(chikungunya,'Este es un virus que se adquiere por inoculación durante la picadura de un mosquito de genero Aedes que se encuentra infectado, este mismo mosquito transmite otros virus de la misma familia capaces de producir también otras fiebres hemorrágicas como es el caso del Dengue y la Fiebre Amarilla. Esta enfermedad no se trasmite por las secreciones ni por el contacto directo con personas enfermas.').

descripcion(cistitis,'Es una infeccion de la mucosa (urocistitis) o de toda la pared (pencstitis) de la vejiga. Tales infecciones urinarias pueden presentarse de forma aislada aguda o repetirse de forma recurrente pudiendo finalmente dar lugar a una cistitis crónica. La mayor parte de las veces las cistitis no presentan complicaciones.').

descripcion(conjuntivitis,'Es una inflamación o irritación de la conjuntiva(membrana que recubre los parpados y el globo ocular). Se trata de una infección benigna, pero es necesario tratarla para evitar complicaciones mayores.').
...
descripcion(dengue,'Es una infección virica trasmitida por la picadura de las hembras infectadas de mosquitos Aedes. Hay cuatro serotipos de virus del dengue. El dengue se presenta en los climas tropicales y subtropicales de todo el planeta, sobre todo en las zonas urbanas y semiurbanas.').

descripcion(diabetes,'Es una enfermedad crónica e irreversible del metabolismo en la que se produce un exceso de glucosa o azúcar en la sangre y en la orina; es debido a una disminución de la sreción de la hormona insulina o a una deficiencia de su acción.').

descripcion(embarazo,'Es el periodo mediante el cual se gesta y desarrolla un embrión, este lapso de tiempo es de aproximadamente 9 meses en seres humanos.').

descripcion(escoliosis,'Es un problema de salud que causa una curvatura de lado a lado en la columna vertebral. La curvatura puede tener forma de S ó C En la mayoria de los casos, no se sabe que causa esta curvatura.').

descripcion(gastritis,'Es la inflamación de la mucosa gástrica, que en la gastroacopia se ve enrojecida, presentadose en forma de manchas rojisas, las cuales representan irritación o hemorragias subepiteliales. Sin embargo, el diagnóstico preciso se obtiene por exploración endoscópica. En esta se apreciará si es solo una parte del estómago la que está afectada o toda la esfera gástrica.').

descripcion(gripe,'Es una enfermedad aguda, febril y contagiosa causada por virus. A diferencia de un resfriado, la gripe es una enfermedad que puede tener una evolución grave. La gripe estacional puede producir epidemias, que se concentran en un momento determinado en ciertos lugares.').

descripcion(leucemia,'Es una enfermedad de los órganos productores de la sangre que se caracteriza por la proliferación excesiva de leucocitos o glóbulos blancos en la sangre y en la médulos ósea.').

descripcion(migrana,'Es un dolor fuerte de cabeza que afecta, generalmente, a un lado o una parte de ella y a menudo va acompañado de nauseas y vómitos.').

descripcion(miopia,'Es una anomalia o defecto del ojo que produce una visión borrosa o poco clara de los objetos lejanos; se debe a una curvatura excesiva del cristalino que hace que las imágenes de los objetos se formen un poco antes de llegar a la retina.').

descripcion(neumonia,'Es una inflamación de las pulmones, causada por la infección de un virus o una bacteria, que se caracteriza por la presencia de fiebre alta, escalofríos, door intenso en el costado afectado del tórax, tos y expectoración.').
...
receta(gripe,'Oseltamivir - CAPSULA - Cada capsula contiene: Oseltamivir 75mg. Envase con 20 capsulas. Via de administracios oral - Adultos y niños mayores de 12 años: 75mg cada 12 horas, durante 5 dias.').
...
150 mg a 300 mg por vía oral cada 12 a 24 horas. Niños: 2 a 4 mg/kg /día, cada 12 horas.').

receta(colera,'Doxiciclina - CÁPSULA O TABLETA - Cada cápsula o tableta contiene:
Hiclato de doxiciclina equivalente a 100 mg de doxicilina. Envase con 10 cápsulas o tabletas. Vía de administración y Dosis: Oral - Adultos: el primer día 100 mg cada 12 horas y continuar con 100 mg/día, cada 12 ó 24 horas Niños mayores de 10 años: 4 mg/kg de peso corporal/día, administrar cada 12 horas el primer día. Después 2.2 mg/kg de peso corporal/día, dividida cada 12 horas.').

receta(coronavirus,'Se recomienda reposo absoluto y que el sistema inmunologico consiga vencer el virus al rededor de 14 dias que es lo que dura en desarrollarse el virus. Se recomienda quedarse en casa para evitar su transmision. Actualmente no hay cura para esta enfermedad. Se puede tomar Paracetamol - TABLETA - Cada tableta contiene: Paracetamol 500mg. Envase con 10 tabletas. Via de Adeministracion: Oral Adultos: 250-500 mg cada 4 ó 6 horas. Niños: De 10 a 30 mg/kg de peso corporal, cada 4 ó 6 horas. Esto solamente es para atenuar la fiebre si los sintomas se complican y tiene dificultad para respirar acudir de inmediato al hospital').
